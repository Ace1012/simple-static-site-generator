...
function parseFile(dir: string): ParsedFile {
...
function getOutPutFilePath(fileName: string, outPath: string) {
...
const parsedFile = parseFile(
  path.join(path.resolve(), "../src/markdown/home.md")
);

const template = fs.readFileSync(
  path.join(path.resolve(), "../src/templates/home.html"),
  "utf-8"
);
